...
const juce::Font AmiLookAndFeel::getCustomFont()
{
    return pixelFont;
}

juce::Typeface::Ptr AmiLookAndFeel::getTypefaceForFont(const juce::Font&)
{
    return typeface;
}

juce::Font AmiLookAndFeel::getLabelFont(juce::Label& label)
{
...
void AmiLookAndFeel::drawButtonText(juce::Graphics& g, juce::TextButton& button, bool, bool shouldDrawButtonAsDown)
{
...
void AmiLookAndFeel::drawButtonBackground(juce::Graphics& g, juce::Button& button, const juce::Colour& backgroundColour,
...
int AmiLookAndFeel::getSliderThumbRadius(juce::Slider& slider)
{
    return slider.isHorizontal() ? static_cast<int> ((float)slider.getHeight() * 0.25f)
                                 : static_cast<int> ((float)slider.getWidth() * 0.5f);
}

void AmiLookAndFeel::drawLinearSlider(juce::Graphics& g, int x, int y, int width, int height, float sliderPos, 
...
void AmiLookAndFeel::drawToggleButton (juce::Graphics& g, juce::ToggleButton& button,
                  bool shouldDrawButtonAsHighlighted, bool shouldDrawButtonAsDown)
{
...
void AmiLookAndFeel::drawTickBox(juce::Graphics& g, juce::Component& component, float x, float y, float w, float h, const bool ticked,
